...
function getStarToday() {
  ...
  for (let i = 0; i < STAR_MONTHS.length; i++) {
    ...
    if (today >= m.startDate && today <= m.endDate) {
      const dayNumber = Math.floor((today - m.startDate) / MS_PER_DAY) + 1;
